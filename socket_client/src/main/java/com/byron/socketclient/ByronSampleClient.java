...
import bizsocket.j2sesame.common.OrderListSerialContext;
import bizsocket.j2sesame.common.SampleBizPacketValidator;
import bizsocket.j2sesame.common.SampleCmd;
import bizsocket.j2sesame.common.SamplePacketFactory;
import bizsocket.j2sesame.common.SampleService;
 ...
 */
public class ByronSampleClient extends AbstractBizSocket {
    public ByronSampleClient(Configuration configuration) {
        super(configuration);
    }
    ...
    public static void startServer(final ByronSampleClient client) {
